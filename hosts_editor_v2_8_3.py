# hosts_editor_v2_8_3.py
# Hosts File Management Tool — v2.8.3
# Patches vs v2.8.2:
# - **NEW FEATURE**: Added "Emergency DNS Unlock" button. 
#   - Generates and runs an external batch script to brute-force kill 'dnscache' and inject a blank hosts file.
#   - Solves system lockups caused by applying massive hosts files.
...
class HostsFileEditor:
    ...
    BLOCKLIST_SOURCES = {
        ...
        "Ads / Tracking / Analytics": [
            ...
            ("Yoyo Ad Servers", "https://pgl.yoyo.org/adservers/serverlist.php?hostformat=hosts&showintro=0&mimetype=plaintext", "Classic ad server list."),
            ...
            ("YouTube Ads Blacklist", "https://raw.githubusercontent.com/anudeepND/youtubeadsblacklist/master/domainlist.txt", "Attempts to block YT ads (variable success)."),
        ...
        "Malware / Phishing / Scam": [
            ...
            ("Phishing Army Ext", "https://phishing.army/download/phishing_army_blocklist_extended.txt", "Extended phishing list."),
    ...
    def __init__(self, root):
        ...
        # --- Emergency DNS Unlock Button (Added in v2.8.3) ---
    ...
    def _init_menubar(self):
        ...
        help_menu.add_command(label="About", command=lambda: self.update_status(
            "Hosts File Management Tool v2.8.3. Created by Steve. Enhanced by Gemini.", is_error=False
        ))
    ...
    # ----------------------------- Emergency DNS Unlock (New in 2.8.3) -----------------
    def emergency_dns_stop(self):
        ...
        # Create a self-elevating batch script content
        bat_content = r"""
@echo off
...
:KILL_LOOP
:: 1. Attempt to copy the blank file over the locked file.
...
"""
        try:
            ...
            # Execute in a NEW console window so it runs even if the Python GUI is frozen
